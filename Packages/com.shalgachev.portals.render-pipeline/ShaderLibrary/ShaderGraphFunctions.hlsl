...
#include "Packages/com.shalgachev.portals.render-pipeline/ShaderLibrary/DeclareDepthTexture.hlsl"
#endif

#if defined(REQUIRE_OPAQUE_TEXTURE)
#include "Packages/com.shalgachev.portals.render-pipeline/ShaderLibrary/DeclareOpaqueTexture.hlsl"
#endif
