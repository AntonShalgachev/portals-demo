...
namespace UnityEditor.Rendering.Universal
{
    ...
    class UniversalPBRSubShader : IPBRSubShader
    {
        ...
        ShaderPass m_ForwardPass = new ShaderPass
        {
            ...
            passInclude = "com.shalgachev.portals.render-pipeline/Editor/ShaderGraph/Includes/PBRForwardPass.hlsl",
            varyingsInclude = "com.shalgachev.portals.render-pipeline/Editor/ShaderGraph/Includes/Varyings.hlsl",
            useInPreview = true,
            ...
            includes = new List<string>()
            {
                ...
                "Packages/com.shalgachev.portals.render-pipeline/ShaderLibrary/Core.hlsl",
                "Packages/com.shalgachev.portals.render-pipeline/ShaderLibrary/Lighting.hlsl",
                "Packages/com.shalgachev.portals.render-pipeline/ShaderLibrary/Shadows.hlsl",
                "Packages/com.shalgachev.portals.render-pipeline/ShaderLibrary/ShaderGraphFunctions.hlsl",
        ...
        ShaderPass m_DepthOnlyPass = new ShaderPass()
        {
            ...
            lightMode = "DepthOnly",
            passInclude = "com.shalgachev.portals.render-pipeline/Editor/ShaderGraph/Includes/DepthOnlyPass.hlsl",
            varyingsInclude = "com.shalgachev.portals.render-pipeline/Editor/ShaderGraph/Includes/Varyings.hlsl",
            useInPreview = true,
        ...
        ShaderPass m_ShadowCasterPass = new ShaderPass()
        {
            ...
            passInclude = "com.shalgachev.portals.render-pipeline/Editor/ShaderGraph/Includes/ShadowCasterPass.hlsl",
            varyingsInclude = "com.shalgachev.portals.render-pipeline/Editor/ShaderGraph/Includes/Varyings.hlsl",
        ...
        ShaderPass m_LitMetaPass = new ShaderPass()
        {
            ...
            lightMode = "Meta",
            passInclude = "com.shalgachev.portals.render-pipeline/Editor/ShaderGraph/Includes/LightingMetaPass.hlsl",
            varyingsInclude = "com.shalgachev.portals.render-pipeline/Editor/ShaderGraph/Includes/Varyings.hlsl",
            ...
            includes = new List<string>()
            {
                ...
                "Packages/com.shalgachev.portals.render-pipeline/ShaderLibrary/Lighting.hlsl",
                "Packages/com.shalgachev.portals.render-pipeline/ShaderLibrary/ShaderGraphFunctions.hlsl",
                "Packages/com.shalgachev.portals.render-pipeline/ShaderLibrary/MetaInput.hlsl",
                "Packages/com.unity.shadergraph/ShaderGraphLibrary/ShaderVariablesFunctions.hlsl"
            },
            pragmas = new List<string>()
            {
        ...
        ShaderPass m_2DPass = new ShaderPass()
        {
            ...
            passInclude = "com.shalgachev.portals.render-pipeline/Editor/ShaderGraph/Includes/PBR2DPass.hlsl",
            varyingsInclude = "com.shalgachev.portals.render-pipeline/Editor/ShaderGraph/Includes/Varyings.hlsl",
