...
namespace UnityEditor.Experimental.Rendering.Universal
{
    ...
    class UniversalSpriteLitSubShader : ISpriteLitSubShader
    {
        ...
        ShaderPass m_LitPass = new ShaderPass
        {
            ...
            passInclude = "com.shalgachev.portals.render-pipeline/Editor/ShaderGraph/Includes/SpriteLitPass.hlsl",
            ...
            includes = new List<string>()
            {
                ...
                "Packages/com.shalgachev.portals.render-pipeline/Shaders/2D/Include/LightingUtility.hlsl",
            },
        ...
        ShaderPass m_NormalPass = new ShaderPass
        {
            ...
            passInclude = "com.shalgachev.portals.render-pipeline/Editor/ShaderGraph/Includes/SpriteNormalPass.hlsl",
            varyingsInclude = "com.shalgachev.portals.render-pipeline/Editor/ShaderGraph/Includes/Varyings.hlsl",
            useInPreview = true,
            ...
            includes = new List<string>()
            {
                ...
                "Packages/com.shalgachev.portals.render-pipeline/ShaderLibrary/Lighting.hlsl",
                "Packages/com.shalgachev.portals.render-pipeline/ShaderLibrary/ShaderGraphFunctions.hlsl",
                "Packages/com.shalgachev.portals.render-pipeline/Shaders/2D/Include/NormalsRenderingShared.hlsl"
            },
            pragmas = new List<string>()
            {
                "prefer_hlslcc gles",
        ...
        ShaderPass m_ForwardPass = new ShaderPass
        {
            ...
            passInclude = "com.shalgachev.portals.render-pipeline/Editor/ShaderGraph/Includes/SpriteForwardPass.hlsl",
            varyingsInclude = "com.shalgachev.portals.render-pipeline/Editor/ShaderGraph/Includes/Varyings.hlsl",
            useInPreview = true,
