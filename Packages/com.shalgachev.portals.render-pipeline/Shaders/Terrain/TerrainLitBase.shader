Shader "Hidden/Universal Render Pipeline/Terrain/Lit (Base Pass)"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Packages/com.shalgachev.portals.render-pipeline/Shaders/Terrain/TerrainLitInput.hlsl"
            #include "Packages/com.shalgachev.portals.render-pipeline/Shaders/Terrain/TerrainLitPasses.hlsl"
            ENDHLSL
        }
        ...
        Pass
        {
            ...
            #include "Packages/com.shalgachev.portals.render-pipeline/Shaders/Terrain/TerrainLitInput.hlsl"
            #include "Packages/com.shalgachev.portals.render-pipeline/Shaders/Terrain/TerrainLitMetaPass.hlsl"
