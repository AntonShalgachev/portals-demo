...
Shader "Hidden/TerrainEngine/Details/UniversalPipeline/WavingDoublePass"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Packages/com.shalgachev.portals.render-pipeline/Shaders/Terrain/WavingGrassInput.hlsl"
            #include "Packages/com.shalgachev.portals.render-pipeline/Shaders/Terrain/WavingGrassPasses.hlsl"
