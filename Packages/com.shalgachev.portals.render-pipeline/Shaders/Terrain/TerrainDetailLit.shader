Shader "Hidden/TerrainEngine/Details/UniversalPipeline/Vertexlit"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Packages/com.shalgachev.portals.render-pipeline/ShaderLibrary/Core.hlsl"
            #include "Packages/com.shalgachev.portals.render-pipeline/ShaderLibrary/Lighting.hlsl"
        ...
        Pass
        {
            ...
            #include "Packages/com.shalgachev.portals.render-pipeline/Shaders/UnlitInput.hlsl"
        ...
        Pass
        {
            ...
            #include "Packages/com.shalgachev.portals.render-pipeline/Shaders/SimpleLitInput.hlsl"
            #include "Packages/com.shalgachev.portals.render-pipeline/Shaders/SimpleLitMetaPass.hlsl"
