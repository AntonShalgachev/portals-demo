Shader "Universal Render Pipeline/Baked Lit"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Packages/com.shalgachev.portals.render-pipeline/Shaders/BakedLitInput.hlsl"
        ...
        Pass
        {
            ...
            #include "Packages/com.shalgachev.portals.render-pipeline/Shaders/BakedLitInput.hlsl"
            #include "Packages/com.shalgachev.portals.render-pipeline/Shaders/BakedLitMetaPass.hlsl"
